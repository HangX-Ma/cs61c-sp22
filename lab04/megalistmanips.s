...
mapLoop:
    lw t1, 0(s0)        # [int *arr] load the address of the array of current node into t1
    lw t2, 4(s0)        # [int size] load the size of the node's array into t2

    slli t3, t0, 2      # get 4 bytes offset
